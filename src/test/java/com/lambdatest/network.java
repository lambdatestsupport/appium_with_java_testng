...
//        ltOptions.put("app","lt://APP10160501221679565658309799");
        ...
        RemoteWebDriver driver = new RemoteWebDriver(new URL("https://" + userName + ":" + accessKey + "@mobile-hub.lambdatest.com/wd/hub"), capabilities);
...
//        Thread.sleep(5000);
        ...
        wait.until(ExpectedConditions.elementToBeClickable(MobileBy.id("url"))).sendKeys("https://www.fast.com");;
