...
public class playstorelogin {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("build", "realtime innovations");
        ...
        capabilities.setCapability("app","lt://APP1016045801684847313052895");
        capabilities.setCapability("console",true);
//        capabilities.setCapability("network",true);
        capabilities.setCapability("idleTimeout","300");
        HashMap<String, String> playstorelogin = new HashMap<>();
        playstorelogin.put("email", "realtimesofttestac@gmail.com");          //Add in your Google account ID
        playstorelogin.put("password", "Testuser@1234");          //Add in your Google account Password
    ...
    public void testSimple() throws Exception
    {
        try
        {
            driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Continue with Google\"]")).click();
            Thread.sleep(15000);
