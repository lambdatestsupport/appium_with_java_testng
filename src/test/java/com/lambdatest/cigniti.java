...
public class cigniti {
    ...
    public void testSimple() throws Exception
    {
           ...
           availableContexts1.stream().filter(context -> context.toUpperCase().contains("WEBVIEW"))
                .forEach(newcontext -> driver.context(newcontext));
           ...
           String currentContext = driver.getContext();
            ...
            availableContexts2.stream().filter(context -> (context.toUpperCase().contains("WEBVIEW") && !context.toUpperCase().contains(currentContext)))
                    .forEach(newcontext -> driver.context(newcontext));
